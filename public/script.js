...
function revGeocode(lat, lon){
    ...
    function onResult(result){
        if(result.items.length>0){
            ...
            document.getElementById("status").innerHTML = '<h1>' + x + '</h1>';
            var i = x.split(",");
            if(getNumber(i)=="Nothing"){
                document.getElementById("card").innerHTML = "Nothing";
            }else{
                document.getElementById("card").innerHTML = getNumber(i);
            }
